...
2. [Клавиша "Ввод" опускается до самого низа.](#2-клавиша-ввод-опускается-до-самого-низа)  
...
4. [Парсинг URL.](#4-парсинг-url-адреса)  
5. [Это URL или поисковый запрос?](#5-это-url-адрес-или-поисковый-запрос)  
6. [Преобразование не-ASCII символов Unicode в имени хоста.](#6-преобразование-символов-юникода-отличных-от-ascii-в-имя-хоста)  
...
12. [Если пакет отброшен?!](#12-если-пакет-отброшен)  
...
16. [Синтаксический анализ - HTML, CSS, JS](#16-браузер)
16.1 [Высокоуровневая структура браузера](#22последующий-рендеринг-и-выполнение-под-управлением-пользователя)
18. [Парсинг HTML.](#17-синтаксический-анализ-html)  
19. [Интерпретация CSS.](#18-интерпретация-css)  
20. [Рендеринг страницы.](#19-рендеринг-страницы)  
21. [Рендеринг процессора.](#20-рендеринг-на-gpu)  
22. [Сервер Windows.](#21-оконный-сервер)  
23. [Последующий рендеринг и пользовательское выполнение.](#22последующий-рендеринг-и-выполнение-под-управлением-пользователя)  
...
### 16.1 Высокоуровневая структура браузера  
